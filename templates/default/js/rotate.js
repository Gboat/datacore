		...
		var imgTool = function(on, maxImg, viewImg, parentId) {
			var width = 0, height = 0, tool = function() {
				...
				if ($(on).hasClass('artZoom2')) {
					var html = '<div class="artZoomBox"><div class="tool"><a class="imgRight" href="#" title="向右转">向右转</a><a class="imgLeft" href="#" title="向左转">向左转</a><a class="viewImg" href="'
							+ viewImg
					...
					var html = '<div class="artZoomBox"><div class="tool"><a class="hideImg" href="#" title="收起">收起</a><a class="imgRight" href="#" title="向右转">向右转</a><a class="imgLeft" href="#" title="向左转">向左转</a><a class="viewImg" href="'
							+ viewImg
							+ '" title="查看原图">查看原图</a></div><a href="'
							+ viewImg

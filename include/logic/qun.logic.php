 ...
 *
 * @Date 2012-04-28 05:53:03 884607604 1301398186 45748 $
 *******************************************************************/
...
class QunLogic
{
	...
	function checkThemeId($post=array()){
		...
		if ($limit>0 && false == ($activity_qun = cache("misc/activity_qun",$CacheConfig['qun']['activity']))) {
	...
	function getRecdQunCid(){
		...
		$qun_list = array();
		$sql = "SELECT `qid`,`name`,`icon`,`member_num`,`topic_num` 
				FROM `".DB::table('qun')."`  

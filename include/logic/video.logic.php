...
class VideoLogic
{
    ...
    function _get_parse_code_default() {
        ...
        $vhconfs = array(
            ...
            "ku6.com" => array("p"=>"/\/([\w\-\_\.]+)\.html/","c"=>"gbk","tp"=>"/\<title\>(.+?)\s*[\-\_].*?\<\/title\>/i","ip"=>"~(?:(?:\<span class=\"s_pic\"\>)|(?:cover\s*[\:\=]\s*[\'\"]))(http\:\/\/[^\"\<]+?\.(?:jpg|jpeg|gif|png|bmp))~i",),

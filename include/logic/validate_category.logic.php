 ...
 *
 * @Date 2012-04-28 05:53:04 503446012 268433022 7520 $
 *******************************************************************/
	...
	{   
        ...
        if ($ids < 1)
        {
			...
			return $ary_info;
                ...
                $province_info = DB::fetch_first("select * from ".DB::table('common_district')." where `id`='".$data['province']."' ");
	    $city_info = DB::fetch_first("select * from ".DB::table('common_district')." where `id`='".$data['city']."' ");

...
{    
	...
	$files = array(ROOT_PATH . 'include/xwb/log/',ROOT_PATH . 'include/xwb/log/backup/',ROOT_PATH . 'include/xwb/log/temp/',ROOT_PATH . 'include/xwb/app.cfg.php',ROOT_PATH . 'include/xwb/set.data.php',ROOT_PATH . 'setting/',ROOT_PATH . 'setting/settings.php',ROOT_PATH . 'setting/sina.php',ROOT_PATH . './data/cache/',);

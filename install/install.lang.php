 ...
 *
 * @Date 2012-04-28 05:53:05 1062964020 200826026 9188 $
 *******************************************************************/
...
(
	...
	'license' => '<p class="subtitle">记事狗微博系统，以下简称记事狗或yqweibo。
...
<li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 记事狗 的整体或任何部分，未经书面许可或未购买去除记事狗版权信息的授权，页面页脚处的 yqweibo名称、官网链接（http:/'.'/www.jishigou.net）和杭州神话信息技术有限公司网站的链接（http:/'.'/www.INET.com） 都必须保留，而不能清除或修改。
...
$msglang = array(
	...
	'lock_exists' => '您已经安装过记事狗微博系统，如果您想重新安装，请删除 data/install.lock install/install.lock 文件，再次运行安装文件。',

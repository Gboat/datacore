...
<style type="text/css">
.media_user_list{margin:-11px 0 0 -9px;*margin:-11px 0 0 -64px;}
</style>
...
<div class="main_t22">
<div class="main_t22l">达人榜<span>（必须上传了个人头像才有机会上榜哦）</span><?php echo $this->hookall_temp['global_topictop_extra1']; ?></div>
<a href="index.php?mod=settings&code=face" title="上传个人头像获得上榜机会"><img src="templates/default/images/quare/btn_uf.gif" /></a>
</div>
<div class="topL">
<script type="text/javascript">
var authort;
...
<div class="Tnav"><div class="Pname">1、最受关注榜</div></div>
<ul class="toplu">
<?php $_v_c_i = 0; ?>
<?php if(is_array($r_users)) { foreach($r_users as $v) { ?>
<?php $_v_c_i++;$_v_c=($_v_c_i<4?"<b class='fontRed'> $_v_c_i </b>":"<b> $_v_c_i </b>"); ?>
<li>
<div class="daren">
<div class="daren2">
<?php if(MEMBER_ID == $v['uid']) { ?>
<img src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } else { ?><a href="javascript:void(0)" onmouseover="get_user_choose(<?php echo $v['uid']; ?>,'_r_users')" onmouseout="clear_user_choose()"><img src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" /></a>
<?php } ?>
</div>
<div id="user_<?php echo $v['uid']; ?>_r_users" class="layS4"></div>
<div class="daren3">
<p><a href="index.php?mod=<?php echo $v['username']; ?>" target="_blank"><?php echo $v['nickname']; ?><?php echo $v['validate_html']; ?></a></p>
<p><?php echo $v['from_area']; ?></p>
<p><?php echo $this->hookall_temp['global_topictop_extra2']; ?></p>
</div>
</div>
</li>
<div id="Pmsend_to_user_area"></div>
<div id="alert_follower_menu_<?php echo $v['uid']; ?>"></div>
<span id="button_<?php echo $v['uid']; ?>" onclick="get_group_choose(<?php echo $v['uid']; ?>);"></span>
<div id="global_select_<?php echo $v['uid']; ?>" class="alertBox" style="display:none"></div>
<div id="get_remark_<?php echo $v['uid']; ?>" ></div>
<?php } } ?>
</ul>
</div>
<div class="topL">
<div class="Tnav"><div class="Pname">2、一周人气榜</div></div>
<ul class="toplu">
<?php $_v_c_i = 0; ?>
<?php if(is_array($day7_r_buddys)) { foreach($day7_r_buddys as $v) { ?>
<?php $_v_c_i++;$_v_c=($_v_c_i<4?"<b class='fontRed'> $_v_c_i </b>":"<b> $_v_c_i </b>"); ?>
<li>
<div class="daren">
<div class="daren2">
<?php if(MEMBER_ID == $v['uid']) { ?>
<img src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } else { ?><img href="javascript:void(0);" onmouseover="get_user_choose(<?php echo $v['uid']; ?>,'_day7_r_buddys');"  onmouseout="clear_user_choose()" src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } ?>
</div>
<div id="user_<?php echo $v['uid']; ?>_day7_r_buddys"></div>
<div class="daren3">
<p><a href="index.php?mod=<?php echo $v['username']; ?>" target="_blank"><?php echo $v['nickname']; ?><?php echo $v['validate_html']; ?></a></p>
<p><?php echo $v['from_area']; ?></p>
<p><?php echo $this->hookall_temp['global_topictop_extra2']; ?></p>
...
<div class="topL">
<div class="Tnav"><div class="Pname">3、一周活跃榜</div></div>
<ul class="toplu">
<?php $_v_c_i = 0; ?>
<?php if(is_array($day7_r_users)) { foreach($day7_r_users as $v) { ?>
<?php $_v_c_i++;$_v_c=($_v_c_i<4?"<b class='fontRed'> $_v_c_i </b>":"<b> $_v_c_i </b>"); ?>
<li>
<div class="daren">
<div class="daren2">
<?php if(MEMBER_ID == $v['uid']) { ?>
<img src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } else { ?><img href="javascript:void(0);" onmouseover="get_user_choose(<?php echo $v['uid']; ?>,'_huoyue');"  onmouseout="clear_user_choose()" src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } ?>
</div>
<div id="user_<?php echo $v['uid']; ?>_huoyue"></div>
<div class="daren3">
<p><a href="index.php?mod=<?php echo $v['username']; ?>" target="_blank"><?php echo $v['nickname']; ?><?php echo $v['validate_html']; ?></a></p>
<p><?php echo $v['from_area']; ?></p>
<p><?php echo $this->hookall_temp['global_topictop_extra2']; ?></p>
...
<div class="topL">
<div class="Tnav"><div class="Pname">4、一周影响榜</div></div>
<ul class="toplu">
<?php $_v_c_i = 0; ?>
<?php if(is_array($day7_r_topics)) { foreach($day7_r_topics as $v) { ?>
<?php $_v_c_i++;$_v_c=($_v_c_i<4?"<b class='fontRed'> $_v_c_i </b>":"<b> $_v_c_i </b>"); ?>
<li>
<div class="daren">
<div class="daren2">
<?php if(MEMBER_ID == $v['uid']) { ?>
<img src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } else { ?><img href="javascript:void(0);" onmouseover="get_user_choose(<?php echo $v['uid']; ?>,'_yingxiang');"  onmouseout="clear_user_choose()" src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } ?>
</div>
<div id="user_<?php echo $v['uid']; ?>_yingxiang"></div>
<div class="daren3">
<p><a href="index.php?mod=<?php echo $v['username']; ?>" target="_blank"><?php echo $v['nickname']; ?><?php echo $v['validate_html']; ?></a></p>
<p><?php echo $v['from_area']; ?></p>
<p><?php echo $this->hookall_temp['global_topictop_extra2']; ?></p>
...
<?php if($credits) { ?>
<div class="topL">
<div class="Tnav"><div class="Pname">5、
<?php if($credits_name) { ?>
<?php echo $credits_name; ?>榜
<?php } else { ?>总积分榜
<?php } ?>
</div></div>
<ul class="toplu">
<?php $_v_c_i = 0; ?>
<?php if(is_array($top_day7_r_sign)) { foreach($top_day7_r_sign as $v) { ?>
<?php $_v_c_i++;$_v_c=($_v_c_i<4?"<b class='fontRed'> $_v_c_i </b>":"<b> $_v_c_i </b>"); ?>
<li>
<div class="daren">
<div class="daren2">
<?php if(MEMBER_ID == $v['uid']) { ?>
<img src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } else { ?><img href="javascript:void(0);" onmouseover="get_user_choose(<?php echo $v['uid']; ?>,'_sign');"  onmouseout="clear_user_choose()" src="<?php echo $v['face']; ?>" onerror="javascript:faceError(this);" />
<?php } ?>
</div>
<div id="user_<?php echo $v['uid']; ?>_sign"></div>
<div class="daren3">
<p><a href="index.php?mod=<?php echo $v['username']; ?>" target="_blank"><?php echo $v['nickname']; ?><?php echo $v['validate_html']; ?></a></p>
<p><?php echo $v['from_area']; ?></p>
<p><?php echo $v['credit']; ?></p>
<p><?php echo $this->hookall_temp['global_topictop_extra2']; ?></p>
</div>
</div>
</li>

<?php /* 2013-01-26 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?><success></success>
<?php if($total_record > 0) { ?>
<div class="newTig" onclick="ajax_reminded('<?php echo $uid; ?>',1); return false;"><a href="#">有<b><?php echo $total_record; ?></b>条新的内容更新，点此查看</a></div>
<?php } ?>

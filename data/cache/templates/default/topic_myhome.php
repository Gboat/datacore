...
<?php if($member) { ?>
    <div class="sideBox">
        <div class="avatar2">
        <a href="index.php?mod=<?php echo $member['username']; ?>" title="<?php echo $member['username']; ?>"><img src="<?php echo $member['face']; ?>" alt="<?php echo $member['nickname']; ?>" onerror="javascript:faceError(this);"/></a>    
    </div>
        <div class="avatar2_info">
        <a href="index.php?mod=<?php echo $member['username']; ?>" title="@<?php echo $member['nickname']; ?>"><b><?php echo $member['nickname']; ?></b></a><?php echo $member['validate_html']; ?>
        <script type="text/javascript">
            $(document).ready(function(){
                $(".member_exp").mouseover(function(){$(".member_exp_c").show();});
                $(".member_exp").mouseout(function(){$(".member_exp_c").hide();});
...
<?php if($this->Config['level_radio']) { ?>
<?php if($this->Config['topic_level_radio']) { ?>
                <a href="index.php?mod=settings&code=exp" title="点击查看微博等级"  target="_blank" class="ico_level wbL<?php echo $member['level']; ?>"><?php echo $member['level']; ?></a>
<?php } ?>
<?php } ?>
<?php if($member['credits']) { ?>
积分：<a title="点击查看我的积分" href="index.php?mod=settings&code=extcredits"><b><?php echo $member['credits']; ?></b></a>
<?php } ?>
</div>
    </div>
        <div class="edit_sign">
<?php $member_signature = cut_str($member['signature'],20); ?>
<?php if($member['uid'] == MEMBER_ID ) { ?>
            <span  title="个人签名：<?php echo $member['signature']; ?>">
            <a href="javascript:viod(0);" onclick="follower_choose(<?php echo $member['uid']; ?>,'<?php echo $member['nickname']; ?>','topic_signature'); return false;" >
<?php if($member['signature']) { ?>
<?php echo $member_signature; ?>
<?php } else { ?>编辑个人签名
<?php } ?>
</a></span>
<?php } else { ?><span  title="个人签名：<?php echo $member['signature']; ?>">
<?php if($member['signature']) { ?>
<?php if('admin' == MEMBER_ROLE_TYPE) { ?>
                    <a href="javascript:void(0);" onclick="follower_choose(<?php echo $member['uid']; ?>,'<?php echo $member['nickname']; ?>','topic_signature');" title="点击修改个人签名">
                    <em ectype="user_signature_ajax_<?php echo $member['uid']; ?>">(<?php echo $member_signature; ?>)</em>
                    </a>
<?php } ?>
<?php } else { ?><?php echo $member['gender_ta']; ?>没有填写个人签名
<?php } ?>
</span>
<?php } ?>
</div>
...
<ul class="Vimg">
<?php if('tag'!=$this->Get['mod']) { ?>
<?php if($this->Config['sina_enable'] && sina_weibo_init($this->Config)) { ?>
    <li class="sina_weibo">
<?php echo sina_weibo_bind_icon($member['uid']); ?>
 &nbsp; 
        <div class="sina_weibo_c">
            <div class="VM_box">
                <div class="VM_top">
...
<?php if($this->Config['qqwb_enable'] && qqwb_init($this->Config)) { ?>
    <li class="qqwb">
<?php echo qqwb_bind_icon($member['uid']); ?>
 &nbsp; 
        <div class="qqwb_c">
            <div class="VM_box">
                <div class="VM_top">
...
<?php if($this->Config['imjiqiren_enable'] && imjiqiren_init($this->Config)) { ?>
    <li class="qqim">
<?php echo imjiqiren_bind_icon($member['uid']); ?>
 &nbsp; 
        <div class="qqim_c">
            <div class="VM_box">
                <div class="VM_top">
...
<?php if($this->Config['sms_enable'] && sms_init($this->Config)) { ?>
    <li class="tel">
<?php echo sms_bind_icon($member['uid']); ?>
 &nbsp; 
        <div class="tel_c">
            <div class="VM_box">
                <div class="VM_top">
                    ...
                    <p>手机短信</p>
                    用自己的手机发微博、通过手机签名发微博，如果有人@你、评论你、关注你、给你发私信，你都可以第一时间收到手机短信的通知<br />
<?php $sms_return  = sms_has_bind($member['uid']); ?>
<?php if(!$sms_return) { ?>
                    <a href="index.php?mod=other&code=sms">绑定手机短信</a> |
<?php } ?>
<a target="_blank" href="index.php?mod=settings&code=user_medal">查看我的勋章</a>
...
<?php echo $this->hookall_temp['global_usernav_extra2']; ?>
        ...
        <!-- 可能感兴趣的人end -->
          ...
          <!-- 热门话题推荐 -->
<?php if(false!=($recommend_topic_user=Load::model('data_block')->recommend_topic_user(10))) { ?>
        <!-- 人气用户推荐 -->
          <script type="text/javascript">
            $(document).ready(function(){
          ...
          <h3>人气用户推荐<a class="btn SC_renqituijian" href="javascript:void(0);"></a></h3>
            <ul class="FTL FTL3 SC_renqituijian_box">
                <div id="<?php echo MEMBER_ID; ?>_recommend_user">
<?php if(is_array($recommend_topic_user)) { foreach($recommend_topic_user as $val) { ?>
                <li> 
...
<?php if(is_array($fans_list)) { foreach($fans_list as $val) { ?>
          ...
          <img onerror="javascript:faceError(this);" src="<?php echo $val['face']; ?>" class="manface"/></a><span><a href="index.php?mod=<?php echo $val['username']; ?>" target="_blank"><?php echo $val['nickname']; ?></a></span>
          </li>
<?php } } ?>
...
<div class="SC">
<h3>手机访问<?php echo $this->Config['site_name']; ?></h3>
<div class="tabmenu">
<ul>
...
<ul class="hidden"><b>3G版</b>：智能手机访问<a href="index.php?mod=other&code=mobile" target="_blank"><?php echo $this->Config['site_url']; ?>/mobile</a>，享受类客户端的体验</ul>
<ul class="hidden"><b>WAP版</b>：手机WAP访问地址<b><a href="index.php?mod=other&code=wap" target="_blank"><?php echo $this->Config['wap_url']; ?></a></b></ul>
<ul class="hidden"><b>短信版</b>：<a href="index.php?mod=other&code=sms" rel="nofollow" target="_blank">手机短信</a>
<?php if($this->Config['sms_enable'] && sms_init($this->Config)) { ?>
<br />页绑定手机后，就可以发短信到<b><?php echo SMS_ID; ?></b>发微博啦！
<?php } ?>
</ul>
</div>
</div>  <!-- 意见反馈-->

<?php /* 2013-01-27 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div id="wrap">&nbsp;</div>
  <div id="wrapc">
    ...
    <div class="login">
     <form method="post"  name="login" action="<?php echo $action; ?>">
<input type="hidden" name="FORMHASH" value='<?php echo FORMHASH; ?>'/>
		<input type="hidden" name="uid" value="<?php echo MEMBER_ID; ?>" />
        <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <th>管理员昵称</th>
            <td><div class="logo-icon">
                <div class="pw"></div>
                <input class="input pw2" id="username" name="username" value="<?php echo MEMBER_NICKNAME; ?>" type="text" /> 
              </div></td>
          </tr>
          <tr>
            <th>管理员密码</th>
            <td><div class="logo-icon">
                <div class="pwpd"></div>
                <input class="input pwpd2" type="password" name="password" />
              </div>
			  </td>
          </tr> 
          <tr>
            <th>&nbsp;</th>
            <td><input name="submit" class="bottom" value="登录" type="submit" /><span class="getpwd"><a onclick="if(document.getElementById('username').value.length > 0) {window.location.href='index.php?mod=get_password';} else {alert('请输入昵称');}" href="#">忘记密码？</a></span>
            </td>
          </tr>
        </table> 
	</form>

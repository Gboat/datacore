...
<form method="post"  name="settings" action="admin.php?mod=setting&code=do_modify_slide" enctype="multipart/form-data">
...
<td valign="top"><input type="checkbox" name="slide[list][<?php echo $k; ?>][enable]" value="1" <?php echo $_checked; ?> /></td>
        ...
        <tr>
            <td valign="top">&nbsp;</td>
            <td valign="top">
            <a href="<?php echo $slide['href']; ?>" target=_blank><img src="<?php echo $slide['src']; ?>" width="540" height="100" border="0" /></a></td>
            <td valign="top">&nbsp;</td> 
        </tr>
        <tr> 
            <td>&nbsp;</td>
...
<?php } } ?>
        <tr>
            ...
            图片大小以540*80为最佳；<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;或上传图片：<input type="file" name="slide_new_pic_0"><br />
        ...
        <tr>
            ...
            图片大小以540*80为最佳；<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;或上传图片：<input type="file" name="slide_new_pic_1"><br />

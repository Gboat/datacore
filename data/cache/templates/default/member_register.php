...
<link href="templates/default/styles/reg.css?v=build+20120428" rel="stylesheet" type="text/css" />
...
<body>
<div class="Rlogo"><h1 class="logo"><a title="<?php echo $this->Config['site_name']; ?>" href="index.php"></a></h1></div>
<div class="main_2">
...
<?php if($inviter_member['nickname']) { ?>
          <tr>
            <td align="center"><img onerror="javascript:faceError(this);" src="<?php echo $inviter_member['face']; ?>" width="54px" height="54px;"/></td>
          ...
          <?php } elseif($this->Config['register_invite_input']) { ?>          <tr>
...
<?php } ?>
    ...
    <div class="R_R">
      ...
      <a class="r_loginbtn" href="<?php echo $this->Config['site_url']; ?>/index.php?mod=login" rel="nofollow" title="快捷登录" onclick="ShowLoginDialog();return false;">请点此登录</a>
...
<?php if($this->Config['kaixin_enable'] && kaixin_init()) { ?>
 &nbsp; 
<?php echo kaixin_login('b'); ?>
<?php } ?>
<?php if($this->Config['fjau_enable'] && fjau_init()) { ?>
 &nbsp; 
<?php echo fjau_login('b'); ?>
<?php } ?>
  </div>
    </div>
  </div>
...
</SCRIPT><script type="text/javascript" src="templates/default/js/jsgst.js?v=build+20120428"></script>

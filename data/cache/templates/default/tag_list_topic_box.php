...
<div class="mainL">
<?php if($tag_extra) { ?>
<?php if($tag_extra['left_top_image']['enable'] && $tag_extra['left_top_image']['src']) { ?>
        <div>
<?php if($tag_extra['left_top_image']['link']) { ?>
            <a target="_blank" href="<?php echo $tag_extra['left_top_image']['link']; ?>"><img style="border:0;width:590px;" src="<?php echo $tag_extra['left_top_image']['src']; ?>" /></a>
<?php } else { ?><img style="border:0;width:590px;" src="<?php echo $tag_extra['left_top_image']['src']; ?>" />
<?php } ?>
</div>
<?php } ?>
<?php if($tag_extra['left_top_text']['enable']) { ?>
        <div style="padding:10px;">
<?php if($tag_extra['left_top_text']['title']) { ?>
            <h3><?php echo $tag_extra['left_top_text']['title']; ?></h3>
<?php } ?>
<?php if($tag_extra['left_top_text']['content']) { ?>
            <div><?php echo $tag_extra['left_top_text']['content']; ?></div>
<?php } ?>
</div>
<?php } ?>
<?php } ?>
...
<?php if($this->Config['ad_enable'] && $this->Config['ad']['ad_list']['tag_view']['header']) { ?>
<div class="L_AD">
<?php echo $this->Config['ad']['ad_list']['tag_view']['header']; ?>
</div>
<?php } ?>
<!--导航 Begin-->
<?php $__code=urlencode($this->Code); ?>
<div class="TopicMan s_fixed">
        <div class="nfTagB">
            <ul> 
<?php if($this->Get['view'] == '')$def="current"; ?>
<li class="<?php echo $def; ?>">
                    <span id="follow_menu_wp">
                        <a title="最新微博" href="index.php?mod=tag&code=<?php echo $__code; ?>">最新微博</a>
                        <em class="navNew"></em>
                    </span>
                </li>
<?php if($this->Get['view'] == 'recd')$recd="current"; ?>
<li class="<?php echo $recd; ?>">
                    <span id="qun_menu_wp">
                            <a class="wp_id" title="官方推荐" href="index.php?mod=tag&code=<?php echo $__code; ?>&view=recd">官方推荐</a>
                    </span>
                </li>
            </ul>
            <div class="clear"></div>
        ...
        <div class="nfBox index_m">
            <div class="left">
                <!--话题筛选 Begin-->
<?php if(empty($this->Get['type']))     $all = "current"; ?>
<?php if($this->Get['type'] == 'pic')     $pic = "current"; ?>
<?php if($this->Get['type'] == 'video') $video = "current"; ?>
<?php if($this->Get['type'] == 'music') $music = "current"; ?>
<?php if($this->Get['view']) $__view = '&view='.$this->Get['view']; ?>
<a title="全部" href="<?php echo $type_url; ?>" class="<?php echo $all; ?>">全部</a>
                <a title="含图片" href="<?php echo $type_url; ?>&type=pic" class="<?php echo $pic; ?>">图片</a>
                <a title="含视频" href="<?php echo $type_url; ?>&type=video" class="<?php echo $video; ?>">视频</a>
                <a title="含音乐" href="<?php echo $type_url; ?>&type=music" class="<?php echo $music; ?>">音乐</a>
                <!--话题筛选 End-->
            </div>
            <div class="clear"></div>
        </div>
...
<?php if($this->Config['ad']['enable']) { ?>
<?php $_jflwjif_counts++; ?>
<?php if(3==$_jflwjif_counts && $this->Config['ad']['ad_list']['tag_view']['middle_center1']) { ?>
        <div class="L_AD"><?php echo $this->Config['ad']['ad_list']['tag_view']['middle_center']; ?></div>
<?php } ?>
<?php if(7==$_jflwjif_counts && $this->Config['ad']['ad_list']['tag_view']['middle_center1']) { ?>
        <div class="L_AD"><?php echo $this->Config['ad']['ad_list']['tag_view']['middle_center1']; ?></div>
<?php } ?>
<?php } ?>
<?php $talkanswerid = ''; ?>
<div class="wb_l_face">
...
<?php if('myhome'== $this->
    Code) { ?>
<?php if($this->
    Config[ad][ad_list][group_myhome][middle_right]) { ?>
    <div class="R_AD"> <?php echo $this->Config['ad']['ad_list']['group_myhome']['middle_right']; ?></div>
<?php } ?>
    <?php } elseif('tag'== $this->
    Get['mod']) { ?>    
<?php if($this->
    Config[ad][ad_list][tag_view][middle_right]) { ?>
    <div class="R_AD"><?php echo $this->Config['ad']['ad_list']['tag_view']['middle_right']; ?> </div>
<?php } ?>
<?php } ?>
<?php } ?>
<?php if($tag_extra) { ?>
<?php if($tag_extra['right_top_text']['enable']) { ?>
    <div class="SC">
<?php if($tag_extra['right_top_text']['title']) { ?>
      <h3><?php echo $tag_extra['right_top_text']['title']; ?></h3>
<?php } ?>
<?php if($tag_extra['right_top_text']['content']) { ?>
      <ul class="FTL">
        <li><?php echo $tag_extra['right_top_text']['content']; ?></li>
      </ul>
<?php } ?>
    </div>
<?php } ?>
<?php if($tag_extra['right_top_image']['enable']) { ?>
    <div class="SC">
<?php if($tag_extra['right_top_image']['title']) { ?>
      <h3><?php echo $tag_extra['right_top_image']['title']; ?></h3>
<?php } ?>
<?php if($tag_extra['right_top_image']['list']) { ?>
      <ul class="FTL">
<?php if(is_array($tag_extra['right_top_image']['list'])) { foreach($tag_extra['right_top_image']['list'] as $v) { ?>
        <li><a href="<?php echo $v; ?>" target="_blank"><img src="<?php echo $v; ?>" style="border:none;width:180px;" /></a></li>
<?php } } ?>
      </ul>
<?php } ?>
    </div>
<?php } ?>
<?php if($tag_extra['right_top_video']['enable']) { ?>
    <div class="SC">
<?php if($tag_extra['right_top_video']['title']) { ?>
      <h3><?php echo $tag_extra['right_top_video']['title']; ?></h3>
<?php } ?>
<?php if($tag_extra['right_top_video']['rlist']) { ?>
      <ul class="FTL">
<?php if(is_array($tag_extra['right_top_video']['rlist'])) { foreach($tag_extra['right_top_video']['rlist'] as $val) { ?>
        <li>
...
<?php } ?>
<?php if($tag_extra['right_top_user']['enable']) { ?>
    <div class="SC">
<?php if($tag_extra['right_top_user']['title']) { ?>
      <h3><?php echo $tag_extra['right_top_user']['title']; ?></h3>
<?php } ?>
<?php if($tag_extra['right_top_user']['rlist']) { ?>
      <ul class="FTL FTL2">
<?php if(is_array($tag_extra['right_top_user']['rlist'])) { foreach($tag_extra['right_top_user']['rlist'] as $val) { ?>
        <li class="h_h2"> <a href="index.php?mod=<?php echo $val['username']; ?>" target="_blank"><img onerror="javascript:faceError(this);" src="<?php echo $val['face']; ?>" class="manface" onmouseover="get_user_choose(<?php echo $val['uid']; ?>,'_user',<?php echo $val['uid']; ?>)" onmouseout="clear_user_choose()"/></a> <b><a href="index.php?mod=<?php echo $val['username']; ?>" target="_blank"><?php echo $val['nickname']; ?></a></b> <!--
...
<div id="Pmsend_to_user_area"></div> </li>
<?php } } ?>
      </ul>
<?php } ?>
    </div>
...
<?php if($day7_r_tags) { ?>
    ...
    <div class="SC">
      <h3>本周热门话题<a class="btn SC_benzhouremen" href="javascript:void(0)"></a></h3>
      <ul class="FTL SC_benzhouremen_box">
<?php if(is_array($day7_r_tags)) { foreach($day7_r_tags as $val) { ?>
        <li><a href="index.php?mod=tag&code=<?php echo $val['name']; ?>"><?php echo $val['name']; ?></a>&nbsp;&nbsp;(<?php echo $val['topic_count']; ?>)</li>
<?php } } ?>
      </ul>
    </div>
<?php } ?>
<?php if($tag) { ?>
    ...
    <div class="SC">
      <h3>关注该话题的人<a class="btn SC_guanzhugaihuati" href="javascript:void(0)"></a></h3>
      <ul class="FTL FTL2 SC_guanzhugaihuati_box">
<?php if(is_array($tag_favorite_list)) { foreach($tag_favorite_list as $val) { ?>
        <li class="h_h2"><a href="index.php?mod=<?php echo $val['username']; ?>" target="_blank"><img onerror="javascript:faceError(this);" style="height:48px;width:48px; border:1px solid #ccc;" src="<?php echo $val['face']; ?>" title="<?php echo $val['nickname']; ?>" class="manface" onmouseover="get_user_choose(<?php echo $val['uid']; ?>,'_user',<?php echo $val['uid']; ?>)" onmouseout="clear_user_choose()"/></a> <b><a href="index.php?mod=<?php echo $val['username']; ?>" target="_blank"><?php echo $val['nickname']; ?></a></b>
          <div id="user_<?php echo $val['uid']; ?>_user" class="layS2"></div>
        </li>
<?php } } ?>
<?php if(!$tag_favorite_list) { ?>
        暂无人关注该话题。
<?php } ?>
      </ul>
<?php if($__my['uid']>0) { ?>
<?php if($is_favorite) { ?>
      <span id="favorite_tag_id"><a href="javascript:void(0);" onclick="favoriteTag('<?php echo $tag; ?>','delete');return false;"><img src="templates/default/images/noattention.gif" /></a></span>
<?php } else { ?>      <span id="favorite_tag_id"><a href="javascript:void(0);" onclick="favoriteTag('<?php echo $tag; ?>');return false;"><img src="templates/default/images/attention.gif" /></a></span>
<?php } ?>
<?php } ?>
    </div>
<?php } ?>
    <!-- 热门话题推荐-->
<?php if($this->
    Config[hot_tag_recommend_enable] && ($hot_tag_recommend = ConfigHandler::get('hot_tag_recommend')) && $hot_tag_recommend['list']) { ?>
    <script type="text/javascript">
            $(document).ready(function(){
...
<?php if($day1_r_tags) { ?>
    ...
    <div class="SC">
      <h3>今日热门话题<a class="btn SC_jinriremen" href="javascript:void(0)"></a></h3>
      <ul class="FTL SC_jinriremen_box">
<?php if(is_array($day1_r_tags)) { foreach($day1_r_tags as $val) { ?>
        <li><a href="index.php?mod=tag&code=<?php echo $val['name']; ?>" target="_blank"><?php echo $val['name']; ?></a></li>
<?php } } ?>
      </ul>
    </div>
<?php } ?>
...
<?php if($this->Config['ad_enable'] && $this->Config['ad']['ad_list']['tag_view']['footer']) { ?>
<div style="text-align:center" class="T_AD">
 <?php echo $this->Config['ad']['ad_list']['tag_view']['footer']; ?>
</div>
<?php } ?>

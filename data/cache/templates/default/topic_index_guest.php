...
<link href="templates/default/styles/index.css?v=build+20120428" rel="stylesheet" type="text/css" />
...
<link href="theme/<?php echo $this->Config['theme_id']; ?>/theme.css?v=<?php echo SYS_BUILD; ?>" rel="stylesheet" type="text/css" />
<?php } ?>
<style type="text/css">
...
<body>
<div id="headWrap"><h1 id="logo"><a title="<?php echo $this->Config['site_name']; ?>" href="index.php"></a></h1></div>
<div id="mainWrapper">
  <div id="topbox">
    <div id="tleft">
<!--幻灯广告-->
      ...
      <div class="talking"> <strong>正在热议：</strong>
        <div id="Tacticle" class="acticle">
          <div id="indemo">
            <div id="Tacticle_s">
<?php if($r_tags) { ?>
<?php if(is_array($r_tags)) { foreach($r_tags as $val) { ?>
<a href="index.php?mod=tag&code=<?php echo $val['name']; ?>" class="Ts"><?php echo $val['name']; ?></a>
<?php } } ?>
<?php } ?>
</div>
            <div id="demo2"></div>
...
<?php } } ?>
          <div class="item">
            ...
            <input type="text" name="<?php echo $login_extract_forms['username_input']['name']; ?>" class="inputtextTag" id="username_input">
            </span> </div>
          <div class="item">
            <label for="password" class="labelTag">密&nbsp;&nbsp;&nbsp;码：</label>
            <span class="enterInput">
            <input type="password" name="<?php echo $login_extract_forms['password_input']['name']; ?>" class="inputtextTag" id="password_input">
            </span> </div>
...
<?php } ?>
          ...
          <div class="item pos_rel">
            ...
            下次自动登录 </label>
            <a onclick="window.location.href='<?php echo $this->Config['site_url']; ?>/index.php?mod=get_password';return false;" href="javascript:void(0)" class="forgetPass" title="点此可通过2种方式重设密码">忘记密码？</a> </span>
            <div class="login-tiparea autologin-tiparea" id="autologin_tiparea">
              <div class="login-tiparea-top"></div>
            </div>
          </div>
...
<?php } ?>
<?php } ?>
        <script type="text/javascript"> var __TOPIC_VIEW__ = '<?php echo $topic_view; ?>'; </script>
...
<h3 style=" width:230px; float:left; margin:15px 0 5px 0; color:#555; font-weight:600;">手机访问<?php echo $this->Config['site_name']; ?></h3>
...
<br /> 加QQ号：<b>
<?php echo imjiqiren_user_qq_robot(); ?>
</b> 为好友，按提示进行绑定便可用QQ发微博啦！
<?php } ?>
</p>
</div>
<?php if($this->Config['ad_enable']) { ?>
<div style="text-align:center" class="Ir_AD">
<?php echo $this->Config['ad']['ad_list']['topic_']['middle_right']; ?>
</div>
<?php } ?>
</div>
</div>
<?php if($this->Config['ad_enable']) { ?>
<div style="text-align:center" class="I_AD"><?php echo $this->Config['ad']['ad_list']['topic_']['footer']; ?></div>
<?php } ?>
<div class="mlink">
<span class="lf">
<?php if($this->

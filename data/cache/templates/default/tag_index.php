...
<div class="tagg4">进入感兴趣的话题页面，你可在页面左侧，对话题进行关注，<BR>
    关注话题后，可在<a href="index.php?mod=topic&code=tag" target="_blank" rel="nofollow">我关注的话题</a>中查看相关微博，还能在<a href="index.php?mod=profile&code=maybe_friend" target="_blank" rel="nofollow">可能感兴趣的人</a>中找到有共同话题的人。 
    </div>        
<div class="tagW">    
<iframe id="hot_tag_frame" name="hot_tag_frame" width="0" height="0" marginwidth="0" frameborder="0" src="about:blank"></iframe>
<form method="post"  action="ajax.php?mod=topic&code=add_favor_tag" enctype="multipart/form-data" name="HotTagForm" target="hot_tag_frame" id="HotTagForm">
<input type="hidden" name="FORMHASH" value='<?php echo FORMHASH; ?>'/> 
<div class="tagv1">
    <div class="tagspan"><span>最热门话题</span></div>
    <ul class="tagv1lu">
<?php if($tag_list && is_array($tag_list) && count($tag_list)) { ?>
<?php $tag_list = array_chunk($tag_list,4); ?>
<?php if(is_array($tag_list)) { foreach($tag_list as $tags) { ?>
<?php if(is_array($tags)) { foreach($tags as $v) { ?>
<?php $tags_num++; ?>
    <li>
    <span name="hot_tag" style="display:none;"><input type="checkbox" name="tag[]" value="<?php echo $v['id']; ?>" /></span>
        <span class="tagvL">
          <?php echo $tags_num; ?>.<a href="index.php?mod=tag&code=<?php echo $v['name']; ?>" target="_blank"><?php echo $v['name']; ?></a></span>
          <span class="tagvR">(<?php echo $v['topic_count']; ?>)
        </span>
    </li>
<?php } } ?>
<?php } } ?>
<?php } ?>
    ...
    <div id="hot_tag" style="display:none;">
        <input type="checkbox" name="hot_tag_ids_all" onclick="formcheckalll(this.form, 'tag','hot_tag_ids_all');" />全选
        <input type="submit" name="Submit" value="提交" />
        <input type="button" name="Submit" value="取消" onclick="hidden_divv('hot_tag');return false;" />
    </div>
<?php if(MEMBER_ID > 0) { ?>
    <div class="thread_add">
        <a href="javascript:void(0);" onclick="show_divv('hot_tag');return false;">加关注话题</a>
    </div>
<?php } ?>
</div>
</form>
<iframe id="guanzu_tag_frame" name="guanzu_tag_frame" width="0" height="0" marginwidth="0" frameborder="0" src="about:blank"></iframe>
<form method="post"  action="ajax.php?mod=topic&code=add_favor_tag" enctype="multipart/form-data" name="guanzuForm" target="guanzu_tag_frame" id="guanzuForm">
<input type="hidden" name="FORMHASH" value='<?php echo FORMHASH; ?>'/>
<div class="tagv1 tagv2">
<div class="tagspan"><span>最受关注话题</span></div>
    <ul class="tagv1lu">
<?php if(is_array($tag_guanzu)) { foreach($tag_guanzu as $guanzu) { ?>
<?php $guanzu_num++; ?>
<li>
        <span name="guanzu_tag" style="display:none;"><input type="checkbox" name="tag[]" value="<?php echo $guanzu['id']; ?>" /></span>
            <span class="tagvL"><?php echo $guanzu_num; ?>.  <a href="index.php?mod=tag&code=<?php echo $guanzu['name']; ?>" target="_blank"><?php echo $guanzu['name']; ?></a></span>
            <span class="tagvR">(<?php echo $guanzu['tag_count']; ?>)</span>
        </li>
<?php } } ?>
</ul>
    <div id="guanzu_tag" style="display:none;">
        <input type="checkbox" name='guanzu_tag_ids_all' onclick="formcheckalll(this.form, 'tag', 'guanzu_tag_ids_all');" >全选
        <input type="submit" name="Submit" value="提交" />
        <input type="button" name="Submit" value="取消" onclick="hidden_divv('guanzu_tag');return false;" />
    </div>
<?php if(MEMBER_ID > 0) { ?>
    <div class="thread_add">
        <a href="javascript:void(0);" onclick="show_divv('guanzu_tag');return false;">加关注话题</a>
    </div>
<?php } ?>
</div>
</form>
...
<div class="tagW">    
<iframe id="tuijian_tag_frame" name="tuijian_tag_frame" width="0" height="0" marginwidth="0" frameborder="0" src="about:blank"></iframe>
<form method="post"  action="ajax.php?mod=topic&code=add_favor_tag" enctype="multipart/form-data" name="tuijianForm" target="tuijian_tag_frame" id="tuijianForm">
<input type="hidden" name="FORMHASH" value='<?php echo FORMHASH; ?>'/>
<div class="tagv1 tagv3">
    <div class="tagspan tagv3lu"><span>推荐话题</span></div>
    <ul class="tagv1lu tagv3lu">
<?php if(is_array($tag_tuijian)) { foreach($tag_tuijian as $tuijian) { ?>
<?php $tuijian_num++; ?>
<li class="tagv3li">
            <span name="tuijian_tag" style="display:none;"><input type="checkbox" name="tag[]" value="<?php echo $tuijian['id']; ?>" /></span>
                <span class="tagvL"><?php echo $tuijian_num; ?>.  <a href="index.php?mod=tag&code=<?php echo $tuijian['name']; ?>" target="_blank"><?php echo $tuijian['name']; ?></a></span>
<?php if($tuijian['topic_count']) { ?>
<span class="tagvR">(<?php echo $tuijian['topic_count']; ?>)</span>
<?php } ?>
</li>
<?php } } ?>
</ul>
    <div id="tuijian_tag" style="display:none;">
        <input type="checkbox" name="tuijian_tag_ids_all" onclick="formcheckalll(this.form, 'tag', 'tuijian_tag_ids_all');" >全选
        <input type="submit" name="Submit" value="提交" />
        <input type="hidden" name="tuijian_tag_name" value="1" />
        <input type="button" name="Submit" value="取消" onclick="hidden_divv('tuijian_tag');return false;" />
    </div>
<?php if(MEMBER_ID > 0) { ?>
    <div class="thread_add">
        <a href="javascript:void(0);" onclick="show_divv('tuijian_tag');return false;">加关注话题</a>
    </div>
<?php } ?>
</div>
</form>
<iframe id="tag7_tag_frame" name="tag7_tag_frame" width="0" height="0" marginwidth="0" frameborder="0" src="about:blank"></iframe>
<form method="post"  action="ajax.php?mod=topic&code=add_favor_tag" enctype="multipart/form-data" name="tag7Form" target="tag7_tag_frame" id="tag7Form">
<input type="hidden" name="FORMHASH" value='<?php echo FORMHASH; ?>'/>
<div class="tagv1 tagv3  tagv4">
    <div class="tagspan tagv3lu"><span>一周热门话题</span></div>
    <ul class="tagv1lu tagv3lu">
<?php if(is_array($tag_r_day7)) { foreach($tag_r_day7 as $tag7) { ?>
<?php $tag7_num++; ?>
<li class="tagv3li">
        <span name="tag7_tag" style="display:none;"><input type="checkbox" name="tag[]" value="<?php echo $tag7['id']; ?>" /></span>
            <span class="tagvL"><?php echo $tag7_num; ?>.  <a href="index.php?mod=tag&code=<?php echo $tag7['name']; ?>" target="_blank"><?php echo $tag7['name']; ?></a></span>
<?php if($tag7['topic_count']) { ?>
<span class="tagvR">(<?php echo $tag7['topic_count']; ?>)</span>
<?php } ?>
</li>
<?php } } ?>
</ul>
    <div id="tag7_tag" style="display:none;">
        <input type="checkbox" name='tag7_tag_ids_all' onclick="formcheckalll(this.form, 'tag', 'tag7_tag_ids_all');" >全选
        <input type="submit" name="Submit" value="提交" />
        <input type="button" name="Submit" value="取消" onclick="hidden_divv('tag7_tag');return false;" />
    </div>
<?php if(MEMBER_ID > 0) { ?>
    <div class="thread_add">
        <a href="javascript:void(0);" onclick="show_divv('tag7_tag');return false;">加关注话题</a>
    </div>
<?php } ?>
</div>
</form>
<iframe id="tag7_gz_tag_frame" name="tag7_gz_tag_frame" width="0" height="0" marginwidth="0" frameborder="0" src="about:blank"></iframe>
<form method="post"  action="ajax.php?mod=topic&code=add_favor_tag" enctype="multipart/form-data" name="tag7_gzForm" target="tag7_gz_tag_frame" id="tag7_gzForm">
<input type="hidden" name="FORMHASH" value='<?php echo FORMHASH; ?>'/>
<div class="tagv1 tagv3 nomar tagv5">
    <div class="tagspan tagv3lu"><span>一周关注话题</span></div>
    <ul class="tagv1lu tagv3lu">
<?php if(is_array($day7_guanzhu)) { foreach($day7_guanzhu as $tag7_gz) { ?>
<?php $tag7_gz_num++; ?>
<li class="tagv3li">
            <span name="tag7_gz_tag" style="display:none;"><input type="checkbox" name="tag[]" value="<?php echo $tag7_gz['id']; ?>" /></span>
                <span class="tagvL"><?php echo $tag7_gz_num; ?>.  <a href="index.php?mod=tag&code=<?php echo $tag7_gz['name']; ?>" target="_blank"><?php echo $tag7_gz['name']; ?></a></span>
<?php if($tag7_gz['tag_count']) { ?>
<span class="tagvR">(<?php echo $tag7_gz['tag_count']; ?>)</span>
<?php } ?>
</li>
<?php } } ?>
</ul>
    <div id="tag7_gz_tag" style="display:none;">
        <input type="checkbox" name='tag7_gz_tag_ids_all' onclick="formcheckalll(this.form, 'tag', 'tag7_gz_tag_ids_all');" >全选
        <input type="submit" name="Submit" value="提交" />
        <input type="button" name="Submit" value="取消" onclick="hidden_divv('tag7_gz_tag');return false;" />
    </div>
<?php if(MEMBER_ID > 0) { ?>
    <div class="thread_add">
        <a href="javascript:void(0);" onclick="show_divv('tag7_gz_tag');return false;">加关注话题</a>
    </div>
<?php } ?>
</div>
</form>
